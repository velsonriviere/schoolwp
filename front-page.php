        ...
        <div class="full-width-split__inner">
          ...
          $homePageEvents = new WP_Query(array(
           ...
           while($homePageEvents->have_posts()){
               ...
               get_template_part('template-parts/content', 'event');//will search for a page name content-event.php
               } ?>
      ...
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
          ...
          <div class="event-summary">
            ...
            <?php } wp_reset_postdata();// resets post data from start of post, basically incase if want to loop  thru again somewhere else on the page ?>
